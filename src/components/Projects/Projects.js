    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Col md={4} className="project-card">
          <ProjectCard
            imgPath={editor} // Replace with your image import or path
            isBlog={false}
            title="Exploit Arena"
        ...
        <Col md={4} className="project-card">
          <ProjectCard
            imgPath={chatify} // Replace with your image import or path
            isBlog={false}
        ...
        <Col md={4} className="project-card">
          <ProjectCard
            imgPath={bitsOfCode} // Replace with your image import or path
            isBlog={false}
